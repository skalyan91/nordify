...
Convert any image to the [Nord colour palette](https://www.nordtheme.com/) using perceptually-uniform Oklab colour snapping, with optional dithering or palette mixing.
