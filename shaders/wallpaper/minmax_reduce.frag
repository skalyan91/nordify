#version 330 core
// Pass 0b: one 2x2->1 step of the min/max reduction chain. Run
// ceil(log2(max(W,H))) times, each halving both dimensions (rounding up),
// until the output is 1x1 -- host-driven ping-pong, same pattern as
// prefix_sum_1d.frag's scan and gmm_iterate.frag's EM steps.
